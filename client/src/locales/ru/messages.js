export default {
  dashboard: {
    page: {
      activationInstructions: 'Отправили по электронной почте {email}.<br />Следуйте инструкциям, чтобы получить доступ к вашим проектам позже.',
      createdTasks: 'задачи созданные',
      finishedTasks: 'задачи законченный',
      projectsInProgress: 'Проектов',
      resendActivationInstructions: 'Вернуть инструкции',
      resendActivationInstructionsDone: 'Сделанный',
      statsChart: 'Статистики о зада́чах',
  ...
  profile: {
    deleteAccount: {
      ...
      understandLabel: 'Saisissez « Я понимаю » pour pouvoir supprimer votre compte',
  ...
  users: {
    ...
    loginForm: {
      passwordForgotten: 'Не помню пароль',
      passwordLabel: 'Пароль',
      submit: 'Войти',
    ...
    registerForm: {
      ...
      tosMustAccept: 'En cliquant sur “Зарегистрироваться”, vous acceptez nos',
